<template lang="html">
  <div class="login-bg">
    <canvas id="login-bg">your browser does not support the canvas tag </canvas>
  </div>
</template>
...
export default {
  ...
  methods: {
    backgroundInit () {
      ...
      let canvas = document.querySelector('#login-bg')
    ...
    // let h = canvas.height = canvas.offsetHeight;
      ...
      let circles = []
      let current_circle = new CurrentCircle(0, 0)// eslint-disable-line
