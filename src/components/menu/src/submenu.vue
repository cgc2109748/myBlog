<template>
  ...
  >
    <div class="el-submenu__title" ref="submenu-title" :style="paddingStyle">
      ...
      <i :class="{
        'v-submenu__icon-arrow': true,
        'fa fa-arrow-down': rootMenu.mode === 'vertical',
        'fa fa-caret-bottom': rootMenu.mode === 'horizontal'
      }">
      </i>
    </div>
...
<script>
  import CollapseTransition from 'src/utils/transitions/collapse-transition';
